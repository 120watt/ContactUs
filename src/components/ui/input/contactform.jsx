...
export function SignupFormDemo() {
  ...
  return (
    (<div
      className="max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input dark:bg-black">
      <form className="my-8" onSubmit={handleSubmit}>
        <div
          className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2 mb-4">
          <LabelInputContainer>
            <Label htmlFor="name" className="text-white">Name</Label>
            <Input id="name" placeholder="Enter your Name" type="text" className="relative z-10" />
          </LabelInputContainer>
          <LabelInputContainer>
            <Label htmlFor="phone"className="text-white">Phone Number</Label>
            <Input id="phone" placeholder="Enter your Phone Number" type="text" className="relative z-10" />
          </LabelInputContainer>
        </div>
        
        <LabelInputContainer className="m-1">
          <Label htmlFor="email" className="text-white">Email Address</Label>
          <Input id="email" placeholder="Enter your E-mail Address" type="email" className="relative z-10" />
        </LabelInputContainer>
      ...
      <textarea
        ...
        className="w-full h-20 p-2 border rounded-lg bg-gray-50 dark:bg-zinc-800 text-black dark:text-white placeholder:text-neutral-400 dark:placeholder:text-neutral-600 relative z-10"
      />
    </LabelInputContainer>
    ...
    <div
        ...
        <div className="text-white p-1 flex ">
            Mail us at:<div className="text-red-500 ">&nbsp; &nbsp;urjotsav@rgipt.ac.in</div> 
        </div>
        ...
        <button
            ...
            <span className="text-neutral-700 dark:text-neutral-300 text-sm"></span>
            <BottomGradient />
        </button>
